    ...
    return (
        <section id="home" className="s-home page-hero target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width={3000} data-natural-height={2000} data-position-y="center">
            ...
            <ul className="home-social">
                ...
                {/*</li>*/}
                <li>
                    <a href="https://twitter.com/arjel_dhiren"><i className="im im-twitter" aria-hidden="true" /><span>Twiiter</span></a>
                </li>
                <li>
                    <a href="https://www.instagram.com/dhirensocrates/"><i className="im im-instagram" aria-hidden="true" /><span>Instagram</span></a>
                </li>
                {/*<li>*/}
